...
export default function BuyPage() {
  ...
  // For demo purposes, using mock data - enhanced with additional fields for display
  const mockCars = [
    {
      id: '1',
      make: 'Ferrari',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mockCars.map((car) => (
            <div key={car.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
              ...
              <CarSlideshow carId={car.id} make={car.make} model={car.model} type="buy" />
              ...
              <div className="p-4">
                ...
                {/* Specifications using icon layout similar to Image 3 */}
                <div className="grid grid-cols-2 gap-y-4 gap-x-2 mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">{car.bodyType}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="text-xs text-gray-500">Horse Power</div>
                      <div className="text-sm font-medium">{car.horsePower}hp</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">{car.engine}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">{car.mileage.toLocaleString()} miles</div>
                    </div>
                  </div>
