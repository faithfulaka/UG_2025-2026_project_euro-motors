        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 p-6 border-b border-black text-black ">
            <div className="flex flex-col items-center">
              ...
              <p className="font-semibold">{car.specifications?.bodyType || 'N/A'}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-semibold">{car.specifications?.transmission || 'N/A'}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-semibold">{car.specifications?.horsePower ? `${car.specifications.horsePower}hp` : 'N/A'}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-semibold">{car.specifications?.engine || 'N/A'}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-semibold">{car.specifications?.mileage ? `${car.specifications.mileage.toLocaleString()} miles` : 'N/A'}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-semibold">{car.specifications?.fuelType || 'N/A'}</p>
            </div>
          </div>
        </div>
